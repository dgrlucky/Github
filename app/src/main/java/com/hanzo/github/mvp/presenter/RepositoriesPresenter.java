...
import com.hanzo.github.mvp.model.SearchResult;
...
public class RepositoriesPresenter extends BasePagerPresenter<IRepositoriesContract.View>
    ...
    private Repository parseCollectionsRepositoryData(Element element) {
...
//        String ownerAvatar = element.select("div > div > a > img").attr("src");
    ...
    private Repository parseTrendingRepositoryData(Element element) {
