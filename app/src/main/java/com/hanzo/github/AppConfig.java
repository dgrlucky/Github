...
public class AppConfig {
    ...
    public final static String GITHUB_CLIENT_ID = BuildConfig.GITHUB_CLIENT_ID;

    public final static String GITHUB_CLIENT_SECRET = BuildConfig.GITHUB_CLIENT_SECRET;
